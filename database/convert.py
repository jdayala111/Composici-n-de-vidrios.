...
# File paths
csv_file_path = '/home/dabit/Descargas/login-main/database/glass.csv'
sql_file_path = '/home/dabit/Descargas/login-main/database/glass.sql'

# Table name
table_name = 'basededatos'
